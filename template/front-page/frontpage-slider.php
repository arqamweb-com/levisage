            ...
            <span
                    class="inline-flex items-center gap-2 rounded-full glass-dark px-5 py-2.5 text-[13px] tracking-[0.3em] text-white border border-white/15"><svg
                        ...
                        class="lucide lucide-sparkles h-3.5 w-3.5 text-[color:var(--gold)]" aria-hidden="true"><path
                            ...
                            d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg> <?php esc_html_e('عناية متطوّرة بمعايير احترافية', 'arqamweb'); ?></span>
            <h1 class="font-arabic mt-8 font-black text-gradient-luxury"
                style="font-size: 3rem; line-height: 1.5; padding-block: 0.2em;"><?php esc_html_e('لوفيزاج — عناية متكاملة', 'arqamweb'); ?> <br
                        class="hidden md:block"><?php esc_html_e('لبشرةٍ أكثر إشراقاً', 'arqamweb'); ?> <br class="hidden md:block"><?php esc_html_e('وشعرٍ أكثر حيويّة', 'arqamweb'); ?></h1>
            <div class="mt-8 flex items-center justify-center lg:justify-start gap-4">
                <div class="hairline w-24 opacity-60"></div>
                <p class="text-xl md:text-2xl text-white/90 font-light tracking-wide mb-0" style="line-height: 1.9;"><?php esc_html_e('منتجات
                    علاجية فاخرة', 'arqamweb'); ?></p>
                <div class="hairline w-24 opacity-60"></div>
            </div>
            <p class="mt-6 text-white/70 text-lg max-w-xl mx-auto lg:mx-0" style="line-height: 2;"><?php esc_html_e('من علاج تساقط الشعر
